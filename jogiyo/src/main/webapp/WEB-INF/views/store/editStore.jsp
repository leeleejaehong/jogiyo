...
<div class="my-page-container">
    ...
    <c:forEach var="dto" items="${findStore}">
        <form name="f" action="/store/editStorePro.do" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="storename" value="${dto.storename}" name="storename" class="my-page-input">
            
            <label for="cateid" class="my-page-label">카테고리:</label>
            <select name="cateid" id="cateid" class="my-page-input">
            ...
            <textarea id="storecontent" rows="5" cols="20" name="storecontent" class="my-page-input">${dto.storecontent}</textarea>
            
            <label for="id" class="my-page-label">점주ID:</label>
            <input type="text" id="id" value="${dto.id}" readonly="readonly" class="my-page-input">
            
            <label for="postcode" class="my-page-label">우편번호:</label>
            <input type="text" name="postcode" id="postcode" placeholder="우편번호" value="${dto.postcode}" class="my-page-input">
            <input type="button" onclick="execDaumPostcode()" value="우편번호 찾기"><br>
            
            <label for="address" class="my-page-label">주소:</label>
            <input type="text" name="address" id="address" placeholder="주소" value="${dto.address}" class="my-page-input"><br>
            
            <label for="detailAddress" class="my-page-label">상세주소:</label>
            <input type="text" name="detailaddress" id="detailAddress" placeholder="상세주소" value="${dto.detailaddress}" class="my-page-input">
            
            <label for="extraAddress" class="my-page-label">참고항목:</label>
            <input type="text" name="extraaddress" id="extraAddress" placeholder="참고항목" value="${dto.extraaddress}" class="my-page-input">
