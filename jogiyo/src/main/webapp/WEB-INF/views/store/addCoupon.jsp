...
<h1 align="center"> 쿠폰 추가 페이지</h1>
	...
	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		<table>
			...
			<tr>
			<td><input type="text" name="couname" title="쿠폰이름(가격)" placeholder=",없이 숫자만 입력해주세요"></td>
			<td><textarea name="coucontent" title="쿠폰내용"></textarea></td>
