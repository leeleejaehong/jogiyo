...
// 데이터가 존재하는지 확인
console.log("Loaded order data:", orderData); // 로컬 스토리지에서 불러온 데이터 확인
$(function() {
if (orderData && orderData.length > 0) {
    ...
    totalDiv.innerHTML = `<h3>총 주문 금액: `+totalAmount+`원</h3>`;
    orderListDiv.appendChild(totalDiv);
    /* document.body.appendChild(totalDiv); */
    //지금 화면에 totalDiv라는 div가 생성만되고 화면에 안띄워주고잇어요
    //위에 거처럼 미리 생성해둔 div에 다가 innerhtml같은걸로 값써줘요 
	} else {
